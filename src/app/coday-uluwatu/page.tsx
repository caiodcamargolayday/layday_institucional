      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-4">
          ...
          >
            ...
            >
              <Button className="bg-[#EE5B2B] text-white hover:bg-[#EE5B2B]/90 rounded-none h-14 px-12 font-bold uppercase tracking-[3px] text-sm shadow-xl transition-transform hover:scale-105 active:scale-95">
                Book Now
              </Button>
            </motion.div>
          </motion.div>
        ...
        <section className="mb-24 md:mb-32 bg-white border-2 border-[#004A61] p-6 md:p-12 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-16">
            <div className="lg:col-span-1">
              ...
              <Button className="mt-8 md:mt-12 w-full bg-[#004A61] text-white hover:bg-[#004A61]/90 rounded-none h-12 md:h-14 font-bold uppercase tracking-widest transition-transform hover:scale-105">
                View Availability
              </Button>
            </div>
