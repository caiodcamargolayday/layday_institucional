      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-16">
        ...
        >
          ...
          <div className="relative z-10 px-4 space-y-4">
            ...
            <Button className="bg-[#EE5B2B] text-white hover:bg-white hover:text-[#004A61] rounded-none h-12 px-12 font-bold uppercase tracking-[4px] text-[10px] transition-all duration-500">
              BOOK NOW
            </Button>
          </div>
        </motion.section>
